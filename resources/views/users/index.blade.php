...
<div class="max-w-6xl mx-auto mt-8">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
            <div>
                <h3 class="text-lg font-bold text-gray-800">Pengurusan Pengguna</h3>
                <p class="text-sm text-gray-500">Senarai pentadbir, staf dan pemilik sistem.</p>
            </div>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-gray-50 text-gray-500 text-xs uppercase tracking-wider">
                        ...
                        <th class="py-3 px-6 font-semibold">Peranan</th>
                        <th class="py-3 px-6 font-semibold text-center">Tindakan</th>
                    </tr>
                </thead>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="py-4 px-6 text-center">
                               <div class="flex justify-center gap-2">
                                    ...
                                    <form action="{{ route('users.destroy', $user->id) }}" method="POST" onsubmit="return confirm('Pasti mahu padam pengguna ini?');">
                                        @csrf @method('DELETE')
